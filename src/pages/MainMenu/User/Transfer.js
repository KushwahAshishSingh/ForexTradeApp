    ...
    <>
      <React.Fragment>
        <div className="page-content">
          <MetaTags>
            <title>Transfer | ForexTrade</title>
          </MetaTags>
          <Container fluid>
            <Breadcrumbs title="User" breadcrumbItem="Transfer" />
            <Row>
              <Col>
                <Card>
                  <CardBody>
                                        ...
                                        <div className="mb-3">
                                          ...
                                          <Input
                                            ...
                                            invalid={
                                              validation.touched
                                                .toaccountnumber &&
                                              validation.errors.toaccountnumber
                                                ? true
                                                : false
                                            }
                                          />
                                          {validation.touched.toaccountnumber &&
                                          validation.errors.toaccountnumber ? (
                                            <FormFeedback type="invalid">
                                              {
                                                validation.errors
